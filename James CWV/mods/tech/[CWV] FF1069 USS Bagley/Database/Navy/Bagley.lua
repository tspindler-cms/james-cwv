...
-- USS Bagley 87 by James J. Jackson

GT = {};
dofile(current_mod_path..'/Database/scripts/Bagley_RunwaysAndRoutes.lua') -- the runways and taxiway lua file
GT_t.ws = 0;

set_recursive_metatable(GT, GT_t.generic_ship) -- all ships have this

GT.visual = {}
GT.visual.shape = "Bagley_dcs"  -- name of LODs lua
...
GT_t.LN_t.ship_mk42_127mm_AIR.PL[1] = {
							shell_name = {"cwv_bag_mk42_127mm_AIR"},
...
GT_t.LN_t.Knox_Phalanx_CIWS.PL[1].shell_name = {"bag_Phalanx_CIWS_MK244_APDS"};
...
GT.Name = "USS Bagley"; -- folder name for Liveries
GT.DisplayName = _("[CWV] USS Bagley (FF-1069)"); -- name in game in ME and on the tape at the bottom
