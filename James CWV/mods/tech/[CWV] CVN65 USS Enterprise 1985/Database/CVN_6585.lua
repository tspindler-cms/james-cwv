...
-- CVN-65 1985 Enterprise by TeTeT, James J. Jackson, Tansoku102cm

GT = {};
-- TODO
dofile(current_mod_path..'/Database/CVN_6585RunwaysAndRoutes.lua') -- the runways and taxiway lua file
GT_t.ws = 0;

set_recursive_metatable(GT, GT_t.generic_ship) -- all ships have this

GT.visual = {}
GT.visual.shape = "cvn65_1985_dcs"  -- name of LODs lua
...
GT.Name = "USS Enterprise 1985" -- folder name for Liveries
GT.DisplayName = _("[CWV] CVN-65 USS Enterprise '85") -- name in game in ME and on the tape at the bottom
...
GT.Sensors = {  OPTIC = {"long-range naval optics", "long-range naval LLTV", "long-range naval FLIR"}, --optics types
                RADAR = {
                    "CVN6585_AN/SPS48 surface",
                    "CVN6585_AN/SPS48 air",}
            }; --radar types
