...
-- USS New Jersey 89 by James J Jackson

GT = {};
dofile(current_mod_path..'/Database/scripts/new_jersey_1989_RunwaysAndRoutes.lua') -- the runways and taxiway lua file
GT_t.ws = 0;

set_recursive_metatable(GT, GT_t.generic_ship) -- all ships have this

GT.visual = {}
GT.visual.shape = "new_jersey_1989_dcs"  -- name of LODs lua
...
GT_t.WS_t.ship_16inch_50.LN[1].PL[1].shell_name = {"cwv_nj89_mk7_406mm_HC"};
...
GT_t.LN_t.ship_mk12_127mm_AIR.PL[1] = {
	shell_name = {"cwv_nj89_mk12_127mm_AIR"},
...
GT_t.LN_t.Iowa_Phalanx_CIWS.PL[1].shell_name = {"cwv_nj89_Phalanx_CIWS_MK244_APDS"};
...
GT.Name = "USS New Jersey 1989" -- folder name for Liveries
GT.DisplayName = _("[CWV] BB-62 USS New Jersey 1989") -- name in game in ME and on the tape at the bottom
