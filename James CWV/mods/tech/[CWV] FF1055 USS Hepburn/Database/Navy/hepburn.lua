...
-- USS Hepburn 91 by James J. Jackson

GT = {};
dofile(current_mod_path..'/Database/scripts/Hepburn_RunwaysAndRoutes.lua') -- the runways and taxiway lua file
GT_t.ws = 0;

set_recursive_metatable(GT, GT_t.generic_ship) -- all ships have this

GT.visual = {}
GT.visual.shape = "hepburn_dcs"  -- name of LODs lua
...
GT_t.LN_t.ship_mk42_127mm_AIR.PL[1] = {
							shell_name = {"cwv_hep_mk42_127mm_AIR"},
...
GT_t.LN_t.Knox_Phalanx_CIWS.PL[1].shell_name = {"Hep_Phalanx_CIWS_MK244_APDS"};
...
GT.Name = "USS Hepburn"; -- folder name for Liveries
GT.DisplayName = _("[CWV] USS Hepburn (FF-1055)"); -- name in game in ME and on the tape at the bottom
