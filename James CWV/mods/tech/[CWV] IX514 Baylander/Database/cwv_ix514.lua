-- Config modified by TeTeT for CWV
-- IX514
GT = {};
GT_t.ws = 0;
...
GT.Landing_Point = { -3.1861-2, 5.6344, 0.0 }
...
GT.Name = "cwv_IX514_unarmed"
GT.DisplayName = _("[CWV] IX514 (unarmed)")
