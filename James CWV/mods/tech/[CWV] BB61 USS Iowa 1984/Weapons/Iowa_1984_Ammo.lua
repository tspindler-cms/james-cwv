...
declare_weapon({
	...
	aiming_table			=
	{
		...
		[1] = { init_vel = 797.0 } -- intentionally not 792 to get less accurate
	}
...
declare_weapon({
	category 				= CAT_SHELLS,
	name 					= "cwv_Iowa84_mk12_127mm_AIR",
...
declare_weapon({
	category 				= CAT_SHELLS,
	name 					= "cwv_Iowa84_Phalanx_CIWS_MK244_APDS", 
