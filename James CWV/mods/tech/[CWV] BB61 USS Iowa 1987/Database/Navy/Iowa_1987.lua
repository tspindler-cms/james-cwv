...
-- USS Iowa 87 by James J Jackson

GT = {};
dofile(current_mod_path..'/Database/scripts/Iowa_1987_RunwaysAndRoutes.lua') -- the runways and taxiway lua file
GT_t.ws = 0;

set_recursive_metatable(GT, GT_t.generic_ship) -- all ships have this

GT.visual = {}
GT.visual.shape = "Iowa_1987_dcs"  -- name of LODs lua
...
GT_t.WS_t.ship_16inch_50.LN[1].PL[1].shell_name = {"cwv_Iowa_mk7_406mm_HC"};
...
GT_t.LN_t.ship_mk12_127mm_AIR.PL[1] = {
	shell_name = {"cwv_Iowa_mk12_127mm_AIR"},
...
GT_t.LN_t.Iowa_Phalanx_CIWS.PL[1].shell_name = {"cwv_Iowa_Phalanx_CIWS_MK244_APDS"};
...
GT.Name = "USS Iowa 1987" -- folder name for Liveries
GT.DisplayName = _("[CWV] BB-61 USS Iowa 1987") -- name in game in ME and on the tape at the bottom
